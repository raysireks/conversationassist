...
export default function InterviewPage() {
  ...
  // Viewer does not create recognizers


  // System audio capture removed for Viewer


  // Mic capture removed for Viewer
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
        <AppBar position="static" color="default" elevation={1}>
          <Toolbar>
            ...
            {/* Settings icon removed for Viewer */}
